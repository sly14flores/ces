...
<html lang="en">
  ...
  <body class="nav-md" id="main-body" ng-app="students" ng-controller="studentsCtrl" account-profile>
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          ...
                          <li><a href="javascript:;" ng-click="form.list(this)">Student List</a></li>
                        </ul>
                      </li>
